...
public abstract class StandOutWindow extends Service {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            CharSequence name = "LogCatViewer";
            String description = "logViewer";
            int importance = NotificationManager.IMPORTANCE_DEFAULT;
            NotificationChannel channel = new NotificationChannel("LogCatChannel", name, importance);
    ...
    public Notification getPersistentNotification(int id) {
        ...
        builder.setChannelId("LogCatChannel");
    ...
    public final synchronized Window show(int id) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            layoutParamsFlags = WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY;
        } else {
            layoutParamsFlags = WindowManager.LayoutParams.TYPE_PHONE;
        }

        // get the params corresponding to the id
        StandOutLayoutParams params = window.getLayoutParams();
        params.type = layoutParamsFlags;
...
//					notification);
    ...
    public class StandOutLayoutParams extends WindowManager.LayoutParams {
        ...
        public static int layoutParamsFlags;
        ...
        public StandOutLayoutParams(int id) {
            super(200, 200, layoutParamsFlags,
